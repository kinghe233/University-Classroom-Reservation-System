<template>
  <div>
    ...
    >
      ...
      <el-form-item label="verified password" prop="repassword">
    ...
    return {
      ...
      rules: {
        ...
        repassword: [
          {
            required: true,
            message: "verified password can't be null",
            trigger: "blur"
          }
        ]
      }
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          ...
          if (this.ruleForm.password != password) {
            this.$message.error("original password is error");
            return;
          }
          if (this.ruleForm.newpassword != this.ruleForm.repassword) {
            this.$message.error("verified password is error");
            return;
          }
