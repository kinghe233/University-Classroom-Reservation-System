    ...
    <div class="index-aside-inner menulist">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item">
		...
		<el-menu :mode="2 == 1? 'horizontal':'vertical'" :unique-opened="true" class="el-menu-demo" default-active="0">
          <el-menu-item index="0" @click="menuHandler('')"><i v-if="true" class="el-icon-menu el-icon-s-home" />Front Page</el-menu-item>
          <el-submenu :index="1+''">
            <template slot="title">
				<i v-if="true" class="el-icon-menu el-icon-user-solid" />
				<span>Personal Center</span>
            </template>
            <el-menu-item :index="1-1" @click="menuHandler('updatePassword')">update password</el-menu-item>
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: rgb(159, 111, 85) !important;
